  ...
  describe(name, function() {
    ...
    describe('construction', function() {
      it('uses pleasant defaults', function () {
        ...
        assert.strictEqual(testNear(cache.initT, initT, 0, 5000), true);
      ...
      it('validates inputs', function () {
        ...
        assert.strictEqual(testMatches(err, /Please supply options.ttk.*keep.*difference/), true);
      });
    });
    ...
    describe('self-monitoring', function () {
      it('calls #expire on a regular interval', function(done) {
        ...
        //
        timer = cache.monitor(monitorT);
        //
        setTimeout(tester, (monitorT * (nloops + 0.8)));
      });
